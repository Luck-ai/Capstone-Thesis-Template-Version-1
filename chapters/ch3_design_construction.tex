...
\hline
\multirow{2}{*}{\shortstack{Spacing\\$S_1$ (cm)}} &
\multirow{2}{*}{\shortstack{Spacing\\$S_2$ (cm)}} &
...
\noindent (Leave one line space)
% for adding an image, place the image in the images folder and use this code. set the desired width and height and change the name from sampleimg.png to the filename and change caption automatically
